...
def talker():
    ...
    """
    pub = rospy.Publisher('/reaching_goal/goal', motion_plan.msg.PlanningActionGoal, queue_size=10)
    rospy.init_node('cmd_generator', anonymous=True)
    rate = rospy.Rate(1) # 10hz



    rospy.Subscriber("/reaching_goal/status",  actionlib_msgs.msg.GoalStatusArray, cmdCallback)
